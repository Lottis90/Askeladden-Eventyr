...
function hovedside() {
    ...
    const kortbrønn = new Blocks.Image("bilder/Bilde6.png", { style: "forsideKort", x: 0, y: 60, width: 200, height: 300 });
    Actions.Click(kortbrønn, () => {
        GaaTil(trykkpåbrønn)
    })
    const kortSKOG = new Blocks.Image("bilder/Bilde7.png", { style: "forsideKort", x: 700, y: 0, width: 200, height: 300 });
    Actions.Click(kortSKOG, () => {
        GaaTil(trykkpåskogen)
    })
    const kortSTUBBE = new Blocks.Image("bilder/Bilde8.png", { style: "forsideKort", x: 700, y: 350, width: 200, height: 300 });
    Actions.Click(kortSTUBBE, () => {
        GaaTil(trykkpåstubben)
    })

    const kortBERG = new Blocks.Image("bilder/Bilde5.png", { style: "forsideKort", x: -10, y: 350, width: 200, height: 300  });
    Actions.Click(kortBERG, () => {
        GaaTil(trykkpåberget);
    })
    const kortSTIG = new Blocks.Image("bilder/Bilde9.png", { style: "forsideKort", x: 180, y: 680, width: 200, height: 300 });
...
function kortSti12() {
    ...
    const forside = new Blocks.Image("bilder/Kort tekst.png", { x: 0, y: 0, width: 1180, height: 820 });
...
function kortbrønn1() {
    ...
    const txt6 = new Blocks.Text("Ved brønnen står du stille og ser, På forsiden medfølgt kort ser du et bilde av en brønn, og på baksiden et bilde av en lønn. Når du ser brønnen reiser du opp, og når du ser lønnen, setter du deg ned. Her må du  agera, fortest mulig reagere. (Voksen tar frem kort med brønn og lønn og vekselvis sier Lønn eller brønn)", { style: "kortTekst", x: 0, y: 0, width: "100%", height: 40 });
    Actions.Click(txt6, () => {
        GaaTil(hovedside)
    })
}
...
function kortbrønn2() {
    const kortbrønn = new Blocks.Image("Bilder/kortbrønn.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("I spillets labyrint, hvor mysterier skjer, En nøtt som er rund, gjemt blant busker og trær. Med et skall som er hardt, og en smak så fin, Den lille nøtten venter, på å bli funnet, så vennlig og blid!", { style: "kortTekst", x: 0, y: 0, width: 100, height: 40 });
    Actions.Click(txt6, () => {
        GaaTil(hovedside)
    })
}
...
function kortbrønn3() {
    const kortbrønn = new Blocks.Image("Bilder/kortbrønn.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Askeladden vil ha vann, han er så tørst,Trykk her fort, så får han en skvett først.Vannet kommer opp fra brønnen og blir klar,Askeladden blir glad når han får sin drikke, så rar!", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 });
...
function klikkepåbrønn() {
    const bakgrunn = new Blocks.Image("bilder/bilde bakgrunn startside.jpg", { x: 0, y: 0, width: 1180, height: 820 })
    let bilde1 = new Blocks.Image("bilder/brønn tom.png", { x: 0, y: 0, width: 400, height: 400 });
    let bilde2 = null;
    let bilde3 = null;
    ...
    Actions.Click(bilde1, () => {
        ...
        if (antalltrykk === 30) {
            bilde1.hide();
            bilde2 = new Blocks.Image("bilder/brønn halvfull.png", { x: 0, y: 0, width: 400, height: 400 });
            Actions.Click(bilde2, () => {
                antalltrykk = antalltrykk + 1;
                if (antalltrykk === 60) {
                    bilde2.hide();
                    bilde3 = new Blocks.Image("bilder/brønn full.png", { x: 0, y: 0, width: 400, height: 400 });
...
function kortBERG1() {
    ...
    const Txt6 = new Blocks.Text("Askeladden trenger din hjelp til å komme seg til toppen av fjellet! Kast terningen for å bestemme hvor mange pinner du kan sette inn, og hjelp Askeladden med å bygge veien oppover.En prikk på terningen, en pinne vi setter, Stadig oppover, det blir bedre og bedre. Med rett antall pinner, stigen blir vår venn, klatringen starter, kom igjen! ", { style: "kortTekst", x: 0, y: 0, width: "100%", height: 40 });
    Actions.Click(Txt6, () => {
        GaaTil(hovedside)
    })
}
function kortBERG2() {
    ...
    const txt6 = new Blocks.Text("Hmmm... Dette fjellet var for glatt til å klatre opp. Kan vi finne noe på brettet som kan hjelpe? Kanskje en gjyllend firebent venn?", { style: "kortTekst", x: 0, y: 0, width: "100%", height: 40 });
    Actions.Click(txt6, () => {
        GaaTil(hovedside)
    })
}
function Kortstubbe1() {
    ...
    const txt6 = new Blocks.Text("Å nei! Den gamle damen har satt nesa si fast i stubben! Hva kan vi finne på brettet som kan hjelpe henne? (Ungene peker ut ett av objektene som er på brettet de syntes kan funke)", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 });
    Actions.Click(kortSTUBBE, () => {
        GaaTil(hovedside)
    })
}
function Kortstubbe2() {
    const kortSTUBBE = new Blocks.Image("stubbekort.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Jeg er skarp, av stål, en glitrende stjerne, For å hjelpe i nød, er det dette jeg lærer. Med meg kan man felle, trærne gir gjenlyd, Damens nese fra stubben, vi frigjør med fryd, Hva er jeg?)", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 });
    Actions.Click(kortSTUBBE, () => {
        GaaTil(hovedside)
    })
}
...
function kortSKOG1() {
    ...
    const txt6 = new Blocks.Text("Trollet nærmer seg, klar til å skape trøbbel! Er dere klare til å vise deres beste dansemoves og danse ham vekk? Musikken er klar, så la oss danse! (Voksen, sett på musikk!)", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 });
    Actions.Click(kortSKOG, () => {
        GaaTil(hovedside)
    })
}
...
function kortSKOG3() {
    const kortSKOG = new Blocks.Image("kortskog.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Trollet utfordrer deg til å kapp spise! Trykk på grøt bollen så fort du kan. Du har 30 sekunder på deg.)", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 })
    Actions.Click(kortSKOG, () => {
        GaaTil(klikkepågrøt)
    })
}
function klikkepågrøt() {
    const bakgrunn = new Blocks.Image("bilder/bilde bakgrunn startside.jpg", { x: 0, y: 0, width: 1180, height: 820 })
    let bilde1 = new Blocks.Image("bilder/grøtskål full.png", { x: 0, y: 0, width: 400, height: 400 });
    let bilde2 = null;
    let bilde3 = null;
    ...
    Actions.Click(bilde1, () => {
        ...
        if (antalltrykk === 30) {
            bilde1.hide();
            bilde2 = new Blocks.Image("bilder/grøtskåll halvfull.png", { x: 0, y: 0, width: 400, height: 400 });
            Actions.Click(bilde2, () => {
                antalltrykk = antalltrykk + 1;
                if (antalltrykk === 60) {
                    bilde2.hide();
                    bilde3 = new Blocks.Image("bilder/tom grøtskål.png", { x: 0, y: 0, width: 400, height: 400 });
                    const tekst = new Blocks.Text("HURRA!", { style: "riktigAlternativ", x: 0, y: 0, width: 400, height: 400 });
...
function kortSTIG1() {
    ...
    const txt6 = new Blocks.Text("Du glemte å mate grisene før du gikk! Gå tilbake til start", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 })
    Actions.Click(txt6, () => {
        GaaTil(hovedside)
    })
}
...
function kortSTIG2() {
    const kortSTIG = new Blocks.Image("kortstig.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Brøl som et troll", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 })
    Actions.Click(txt6, () => {
        GaaTil(hovedside)
    })
}
function kortSTIG3() {
    const kortSTIG = new Blocks.Image("kortstig.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Kast en gang til", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 })
    Actions.Click(txt6, () => {
        GaaTil(hovedside)
    })
}
function kortSTIG4() {
    const kortSTIG = new Blocks.Image("kortstig.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Askeladden ble veldig sliten, stå over et kast ", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 })
    Actions.Click(txt6, () => {
        GaaTil(hovedside)
    })
}
function KortSTIG5() {
    const kortSTIG = new Blocks.Image("kortstig.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Hurra! Du kan gå frem ", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 })
    const randomnumber = Math.floor(Math.random() * 6) + 1
    const alternativ2 = new Blocks.Text(tekst + randomnumber + " Ganger", { style: "Alternativkort", x: 200, y: 500, width: 100, height: 100 });
...
function KortSTIG6() {
    const kortSTIG = new Blocks.Image("kortstig.png", { x: 0, y: 0, width: 1180, height: 820 });
    const txt6 = new Blocks.Text("Du datt i vannet! Gå tilbake:", { style: "kortTekst", x: 0, y: 0, width: 40, height: 40 })
    const randomnumber = Math.floor(Math.random() * 6) + 1
    const alternativ2 = new Blocks.Text(tekst + randomnumber + " Ganger", { style: "Alternativkort", x: 200, y: 500, width: 100, height: 100 });
...
function kortmedalternivstig1() {
    const kortSTIG = new Blocks.Image("kortstig.png", { x: 0, y: 0, width: 1180, height: 820 });
    const tekst = "Hva er det Espen Askeladd sier når han finner noe?"
    const alternativ1 = "Jeg fant, jeg fant "//riktig
    const alternativ2 = "Hva er det?"
    const alternativ3 = "Min min min!"
...
function kortmedalternativstig4() {
    ...
    const alleAlternativ = [alternativ1, alternativ2, alternativ3, alternativ4,]
...
function kortmedalternativstig5() {
    ...
    let alternativ = new Blocks.Text("Hvordan starter et eventyr?", { style: "kortitel", x: 0, y: 0, width: "100%", height: 20 });
...
function kortmedalternativstig6() {
    ...
    const spørsmål = new Blocks.Text("Hvordan avsluttes ett eventyr?", { style: "kortTekst", x: 50, y: 20, width: "100%", height: 100 });
        let alternativ5 = new Blocks.Text("1.Snipp Snapp Snutte", { style: "kortTekst", x: 50, y: 250, width: "100%", height: 100 });
...
function kortmedalternativstig8() {
    ...
    let alternativ2 = new Blocks.Text("1.På do", { style: "kortTekst", x: 50, y: 100, width: "100%", height: 100 });
    let alternativ5 = new Blocks.Text("4.I skogen", { style: "kortTekst", x: 50, y: 250, width: "100%", height: 100 });
...
function kortmedalternativstig11() {
    const kortSTIG = new Blocks.Image("kortstig.png", { x: 0, y: 0, width: 1180, height: 820 });
    const tekst = "Du ser et stort troll! løp frem steg"
    const randomnumber = Math.floor(Math.random() * 6) + 1
    const alternativ2 = new Blocks.Text(tekst + randomnumber + " Ganger", { style: "Alternativkort", x: 200, y: 500, width: 100, height: 100 });
    nesteSide(bakgrunn, hovedside)
}
